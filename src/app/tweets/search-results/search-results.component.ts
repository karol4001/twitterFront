...
export class SearchResultsComponent implements OnInit, OnDestroy {
  ...
  constructor(private http: HttpClient, private twitterService: TwiterServiceService, private changeDetectorRef: ChangeDetectorRef) {
    this.getValue();
  }
  ...
  ngOnInit(): void {
    // if (this.twitterService.subsVar==undefined) {
    //   this.twitterService.subsVar = this.twitterService.invokeSearch.subscribe(() => {
    //     this.resultsViewUsers();
    //   })
    // }
